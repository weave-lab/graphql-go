# graphql-go [![Sourcegraph](https://sourcegraph.com/github.com/weave-lab/graphql-go/-/badge.svg)](https://sourcegraph.com/github.com/weave-lab/graphql-go?badge) [![Build Status](https://semaphoreci.com/api/v1/weave-lab/graphql-go/branches/master/badge.svg)](https://semaphoreci.com/weave-lab/graphql-go) [![GoDoc](https://godoc.org/github.com/weave-lab/graphql-go?status.svg)](https://godoc.org/github.com/weave-lab/graphql-go)
...
- subscriptions
   - [sample WS transport](https://github.com/weave-lab/graphql-transport-ws)

## Roadmap

We're trying out the GitHub Project feature to manage `graphql-go`'s [development roadmap](https://github.com/weave-lab/graphql-go/projects/1).
